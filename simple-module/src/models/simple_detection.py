...
class SimpleDetection(Sensor, EasyResource):
    ...
    def new(
        ...
        Returns:
            Self: The resource
        """
        # todo old in case I need to redo delete when done
    ...
    def validate_config(cls, config: ComponentConfig) -> Sequence[str]:
        ...
        if not SimpleDetection.DETECTION_CONFIDENCE_ATTRIBUTE in fields:
            raise Exception("Missing detection_confidence attribute") 
        elif not fields[SimpleDetection.DETECTION_CONFIDENCE_ATTRIBUTE].HasField("number_value"):
    ...
    def reconfigure(
        ...
        self.actual_camera_name = str(config.attributes.fields[SimpleDetection.CAMERA_ATTRIBUTE].string_value)

        self.actual_sensor_name = str(config.attributes.fields[SimpleDetection.SENSOR_ATTRIBUTE].string_value)
        ...
        self.detection_confidence = config.attributes.fields[SimpleDetection.DETECTION_CONFIDENCE_ATTRIBUTE].number_value
